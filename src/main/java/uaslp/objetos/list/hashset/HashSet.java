...
public class HashSet<T> implements Set<T> {
    ...
    public void add(T element) throws NotValidIndexException, NotNullValuesAllowedException {
        ...
        //System.out.println(element.hashCode() % buckets.length);
        ...
        /*if(buckets[bucketIndex].getSize() == 6)
            System.out.println("Elemento: "+ element);*/
        //System.out.println("Size: " + buckets[bucketIndex].getSize());
        //System.out.println(BUCKET_SIZE_THRESHOLD);
        if (!disableReorganization && buckets[bucketIndex].getSize() > BUCKET_SIZE_THRESHOLD) {
            //System.out.println(buckets[bucketIndex].getSize() + " " + element.hashCode());
            reorganize();
        }
    }
