...
public class ArrayListTest {
    ...
    public void givenANewList_whenGetAt_thenExceptionIsThrown() {
        ...
        //Then:
        Assertions.assertEquals(0, array.getSize(), "Size of list after creation must be zero");
    }
    ...
    @Test
    public void givenAListWith1Element_whenAddAtFront_thenSizeIsTwo() throws NotNullValuesAllowedException {
        //Given:
        ArrayList<String> array = new ArrayList<>();
    ...
    @Test
    public void givenAListWith1Element_whenRemove_thenSizeIsZero() throws NotNullValuesAllowedException {
        //Given:
        ArrayList<String> array = new ArrayList<>();
        array.addAtFront("Hola");
    ...
    @Test
    public void givenAFullList_whenAddAnElementInFront_thenIncreaseDubleZice() throws NotNullValuesAllowedException {
        //given
    ...
    @Test
    public void givenAFullList_whenAddAnElementInTail_thenIncreaseDubleZice() throws NotNullValuesAllowedException {
        //given
        ArrayList<String> array = new ArrayList<>(1);
        array.addAtTail("Hola");
        //when
    ...
    @Test
    public void givenAList_whenUsegetName_thenReturnArrayList() throws NotNullValuesAllowedException {
        //given
        ArrayList<String> array = new ArrayList<>(1);
        array.addAtTail("Hola");
        String text;
        ...
        Assertions.assertEquals("ArrayList",text);
    }
